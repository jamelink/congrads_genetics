...
usage()
{
   ...
   echo "qsub -N <name> /home/jitame/bin/code/CONGRADS_language/04_regenie/02_gwas/regenie_step_2_gwas_multi_cmap.sh -c <chrom_number>"
   echo -e "------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n"
...
--pred $pred_path/CONGRADS_65k_ic_cmaps_st1_cmap_pred.list \
...
--multiphen \
--par-region b37 \
--out $out_path/CONGRADS_gwas_cmap_65k_multi_c${chr}

...
usage()
{
   ...
   echo " "
   echo "Usage: bash /home/jitame/bin/code/FLICA_language/03_regenie/02_gwas/regenie_step_2_qc/variant_qc_wrapper.sh -c <CHROM>"
   ...
   echo "qsub -N variant_qc /home/jitame/bin/code/FLICA_language/03_regenie/02_gwas/regenie_step_2_qc/variant_qc_wrapper.sh -c <chrom_number>"
   echo -e "------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n"
...
code_path=/home/jitame/bin/code/CONGRADS_language/03_regenie/02_gwas/regenie_step_2_qc/

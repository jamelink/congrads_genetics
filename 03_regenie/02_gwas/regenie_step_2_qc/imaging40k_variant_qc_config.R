...
subset_name="CONGRADS"

# Directory containing the SNP statistics files
stats_dir="/data/clusterfs/lag/users/jitame/CONGRADS/geno/regenie/st2_in_gwas"

# Directory where output is written to
working_dir="/data/clusterfs/lag/users/jitame/CONGRADS/geno/regenie/st2_in_gwas/"
